...
trainset = dset.ImageFolder(root='edge/training', transform=transform)
# trainloader = torch.utils.data.DataLoader(trainset, batch_size=4, shuffle=True, num_workers=2)
testset = dset.ImageFolder(root='edge/testing', transform=transform)
...
torch.save(net, 'checkpoint.pth.tar')

#last_json_path = os.path.join(model_dir, "metrics_val_last_weights.json")
#torch.utils.save_dict_to_json(val_metrics, last_json_path)
print(LOSS)
